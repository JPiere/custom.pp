 ...
 *
 */
public class CustomPPProcessFactory implements IProcessFactory {

	private final static CLogger log = CLogger.getCLogger(CustomPPProcessFactory.class);

	/**
	 * default constructor
	 */
	public CustomPPProcessFactory() {
	}
	...
	public ProcessCall newProcessInstance(String className) {
				...
				|| className.startsWith("jpiere.base.plugin.org.adempiere.process.PP"))
		{
			...
			process = EquinoxExtensionLocator.instance().locate(ProcessCall.class, "custom.pp.jpiere.base.plugin.org.adempiere.process", className, null).getExtension();
			if (process == null) {
				//Get Class
