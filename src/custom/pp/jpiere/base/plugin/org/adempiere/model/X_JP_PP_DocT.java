...
/** Generated Model for JP_PP_DocT
 *  @author iDempiere (generated) 
 *  @version Release 10 - $Id$ */
@org.adempiere.base.Model(table="JP_PP_DocT")
public class X_JP_PP_DocT extends PO implements I_JP_PP_DocT, I_Persistent 
{
...
// 1
    ...
    /** Standard Constructor */
    public X_JP_PP_DocT (Properties ctx, int JP_PP_DocT_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_PP_DocT_ID, trxName, virtualColumns);
      /** if (JP_PP_DocT_ID == 0)
        {
			setC_DocType_ID (0);
// @SQL=SELECT C_DocType_ID AS DefaultValue FROM C_DocType WHERE DocBaseType='JDD' AND IsDefault='Y' ORDER BY C_DocType_ID
...
// 1
    ...
    /** Load Constructor */
    public X_JP_PP_DocT (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_PP_DocT[")
	...
	*/
	...
	/** Set PP Doc Template(UU).
		@param JP_PP_DocT_UU PP Doc Template(UU)
	*/
	public void setJP_PP_DocT_UU (String JP_PP_DocT_UU)
	{
		set_Value (COLUMNNAME_JP_PP_DocT_UU, JP_PP_DocT_UU);
	}

	/** Get PP Doc Template(UU).
		@return PP Doc Template(UU)	  */
	public String getJP_PP_DocT_UU()
	{
		return (String)get_Value(COLUMNNAME_JP_PP_DocT_UU);
	}
