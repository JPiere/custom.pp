 ...
 *
 */
public class MPPMMPlanLineT extends X_JP_PP_MM_PlanLineT {

	private static final long serialVersionUID = 5527653716955014059L;

	public MPPMMPlanLineT(Properties ctx, int JP_PP_MM_PlanLineT_ID, String trxName) 
	{
		super(ctx, JP_PP_MM_PlanLineT_ID, trxName);
	}

	public MPPMMPlanLineT(Properties ctx, int JP_PP_MM_PlanLineT_ID, String trxName, String... virtualColumns) 
	{
		super(ctx, JP_PP_MM_PlanLineT_ID, trxName, virtualColumns);
	}

	public MPPMMPlanLineT(Properties ctx, ResultSet rs, String trxName)
	{
		super(ctx, rs, trxName);
	}
	
	/** Parent							*/
	protected MPPPlanT m_parent = null;
	...
	{
		if (m_parent == null)
			m_parent = new MPPPlanT (getCtx(), getJP_PP_PlanT_ID(), get_TrxName());
		return m_parent;
	}	//	getParent
