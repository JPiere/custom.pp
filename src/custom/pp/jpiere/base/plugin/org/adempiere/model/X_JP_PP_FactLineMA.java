...
/** Generated Model for JP_PP_FactLineMA
 *  @author iDempiere (generated) 
 *  @version Release 8.2 - $Id$ */
public class X_JP_PP_FactLineMA extends PO implements I_JP_PP_FactLineMA, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_JP_PP_FactLineMA (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_PP_FactLineMA[")
	...
	/** Set PP Fact Line MA.
		@param JP_PP_FactLineMA_ID PP Fact Line MA	  */
	public void setJP_PP_FactLineMA_ID (int JP_PP_FactLineMA_ID)
	{
		if (JP_PP_FactLineMA_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_JP_PP_FactLineMA_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_JP_PP_FactLineMA_ID, Integer.valueOf(JP_PP_FactLineMA_ID));
	}

	/** Get PP Fact Line MA.
		@return PP Fact Line MA	  */
	public int getJP_PP_FactLineMA_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_JP_PP_FactLineMA_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set PP Fact Line MA(UU).
		@param JP_PP_FactLineMA_UU PP Fact Line MA(UU)	  */
	public void setJP_PP_FactLineMA_UU (String JP_PP_FactLineMA_UU)
	{
		set_Value (COLUMNNAME_JP_PP_FactLineMA_UU, JP_PP_FactLineMA_UU);
	}

	/** Get PP Fact Line MA(UU).
		@return PP Fact Line MA(UU)	  */
	public String getJP_PP_FactLineMA_UU () 
	{
		return (String)get_Value(COLUMNNAME_JP_PP_FactLineMA_UU);
	}
