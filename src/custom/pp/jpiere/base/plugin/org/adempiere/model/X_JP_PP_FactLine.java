...
@org.adempiere.base.Model(table="JP_PP_FactLine")
...
// N
    ...
    /** Standard Constructor */
    public X_JP_PP_FactLine (Properties ctx, int JP_PP_FactLine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_PP_FactLine_ID, trxName, virtualColumns);
      /** if (JP_PP_FactLine_ID == 0)
        {
			setIsCreated (null);
// N
