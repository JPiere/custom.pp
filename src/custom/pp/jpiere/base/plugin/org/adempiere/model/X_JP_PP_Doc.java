...
/** Generated Model for JP_PP_Doc
 *  @author iDempiere (generated) 
 *  @version Release 10 - $Id$ */
@org.adempiere.base.Model(table="JP_PP_Doc")
public class X_JP_PP_Doc extends PO implements I_JP_PP_Doc, I_Persistent 
{
    ...
    public X_JP_PP_Doc (Properties ctx, int JP_PP_Doc_ID, String trxName)
    {
      ...
      /** if (JP_PP_Doc_ID == 0)
        {
			setC_DocType_ID (0);
// @SQL=SELECT C_DocType_ID AS DefaultValue FROM C_DocType WHERE DocBaseType='JDD' AND IsDefault='Y' ORDER BY C_DocType_ID
			setC_UOM_ID (0);
...
// N
			setJP_PP_ScheduledEnd (new Timestamp( System.currentTimeMillis() ));
// @#Date@
			setJP_PP_ScheduledStart (new Timestamp( System.currentTimeMillis() ));
// @#Date@
...
// 1
    ...
    /** Standard Constructor */
    public X_JP_PP_Doc (Properties ctx, int JP_PP_Doc_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_PP_Doc_ID, trxName, virtualColumns);
      /** if (JP_PP_Doc_ID == 0)
        {
			setC_DocType_ID (0);
// @SQL=SELECT C_DocType_ID AS DefaultValue FROM C_DocType WHERE DocBaseType='JDD' AND IsDefault='Y' ORDER BY C_DocType_ID
...
// 1
    ...
    /** Load Constructor */
    public X_JP_PP_Doc (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_PP_Doc[")
	...
	*/
	...
	/** Set PP Doc (UU).
		@param JP_PP_Doc_UU PP Doc (UU)
	*/
	public void setJP_PP_Doc_UU (String JP_PP_Doc_UU)
	{
		set_Value (COLUMNNAME_JP_PP_Doc_UU, JP_PP_Doc_UU);
	}

	/** Get PP Doc (UU).
		@return PP Doc (UU)	  */
	public String getJP_PP_Doc_UU()
	{
		return (String)get_Value(COLUMNNAME_JP_PP_Doc_UU);
	}
